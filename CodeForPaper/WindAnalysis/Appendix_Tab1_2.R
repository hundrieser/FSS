...
for (i in 1:2) {
  ...
  print(testResults.DataFrame[[i]])
}

# FSS_Tests Basel
# 0.944 1.000 0.966 0.752 1.000 0.997 0.916 0.992 0.976 0.996 0.999 0.942 0.956 1.000 0.932 0.988 0.977 1.000 1.000 0.986 

# FSS_Tests Goettingen
# 0.992 0.991 0.997 0.994 0.876 1.000 0.962 1.000 0.969 1.000 1.000 0.974 0.999 1.000 0.993 0.997 1.000 0.343 0.983 0.998
